...
\item v1.3 - Add section on gate driver selection
\end{itemize}
...
\subsubsection{Switch Selection}\label{switchselection}
...
\subsubsection{Gate Driver Selection}

The EPC8004 is a suitable choice for a switch but to fully utilise this device we need a gate driver that can output a suitable current to drive the GaNFET. The specification required a sub-1~ns pulse, which means a combined rise and fall time has to be less than 1~ns to achieve said pulse width. Another requirement was for the component to be readily available and not to be end-of-life.
Through market research, the Texas Instruments LMG line was identified as a good fit for these requirements. They offered multiple devices in the lineup, listed in \cref{tab:LMGFamily}, and the LMG1020 was the most suitable based on number of output channels and timing features. The LMG1020 driver was ordered for use with pulser board prototypes, and was found to drive various switches well, as described in \cref{switchselection}. For these reasons, the LMG1020 driver was chosen.

\begin{table}[h]
  \centering
  \caption{Texas Instrument LMG family of devices}
  \label{tab:LMGFamily}
  \begin{tabular}{l | c | c | c}
    \toprule
    Part number & Output Channels & Rise Time [ps] & Fall Time [ps] \\
    \midrule
    LMG1020    & 1      & 375 & 350     \\
    LMG1210    & 2      & 500 & 500    \\
    LMG1025   & 1      & 650 & 850     \\
